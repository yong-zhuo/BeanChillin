...
const WelcomePage = ({state}:WelcomeProps) => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <Image src="/onboarding/welcome.svg" alt="Welcome Image" height={200} width={280} className="min-w-[200px] min-h-[100px] w-[350px] h-[200px] lg:w-[350px] lg:h-[200px] 2mxl:w-[400px] 2mxl:h-[200px] 3mxl:h-[280px] 3mxl:w-[400px] 3xl:w-[400px] 3xl:h-[400px]"/>
      </div>
