...
export default function ChatForm(data: ChatFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="absolute inset-x-0 bottom-0 bg-white h-[100px]">
            <div className="flex">
                <input type="text" name="message" placeholder={key === undefined ? "You are not friends with the user" : "Type your message..."} className="flex-grow outline-pri h-[100px]" disabled={key === undefined ? true : false} />
