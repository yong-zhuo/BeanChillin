      ...
      <Tabs defaultValue="account">
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button className="text-xs sm:text-md flex w-fit flex-row items-center justify-center gap-1 bg-gray-400 text-white shadow-md transition hover:scale-105 hover:bg-gray-600">
              Group Settings
